...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans transition-colors duration-200">
      ...
      <main className="flex-1 flex flex-col lg:grid lg:grid-cols-12 gap-0 md:gap-6 min-h-0 overflow-hidden">

        {/* Left: Tasks Panel */}
        <section className="lg:col-span-7 xl:col-span-8 flex flex-col min-h-0 bg-white dark:bg-slate-900 md:rounded-3xl shadow-md border-x md:border border-gray-200 dark:border-slate-800 overflow-hidden">
        ...
        <section className="lg:col-span-5 xl:col-span-4 flex flex-col min-h-0 bg-white dark:bg-slate-900 md:rounded-3xl shadow-md border-x md:border border-gray-200 dark:border-slate-800 overflow-hidden">
